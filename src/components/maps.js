...
<p style={{ textAlign: 'center', fontFamily: "var(--font-league-spartan), sans-serif", fontSize: 25, color: BRAND.greenDark, margin: "8px 0 26px"}}>UFABC campus de Santo André </p>
